 ...
 * at most 24 h), which `earth.location.share` enforces before any round trip.
 */
import {
...
/** A day: the ceiling the spec names for a custom length. */
export const DAY_MINUTES = 24 * 60

/** Custom lengths offered, in minutes, within the domain bounds (never above a day). */
export const CUSTOM_DURATION_MINUTES: readonly number[] = [
  15,
  30,
  120,
  240,
