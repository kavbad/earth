 ...
 * with active-speaker emphasis. Pure so the selector is unit-tested without a device.
 */
...
/**
 * Fraction of the stage height the adaptive layout gives the strip of secondary tiles; the lead
 * tile takes the rest. Tiles in the strip are square-ish thirds of the width.
 */
export const ADAPTIVE_STRIP_FRACTION = 0.28

/** How many tiles a `grid` row holds (2 × 2 for 3–4 people). */
