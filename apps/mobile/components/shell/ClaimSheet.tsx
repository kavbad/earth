...
/** The sheet itself (rendered by the provider). */
  ...
  return (
    <Sheet open={open} onClose={onDismiss} title={copy.claimToJoinConversation}>
      <View style={styles.actions}>
        <Button variant="primary" fullWidth label={copy.claimYourPlace} onPress={onClaim} />
        <Button variant="quiet" fullWidth label={copy.notNow} onPress={onDismiss} />
      </View>
    </Sheet>
  )
}
