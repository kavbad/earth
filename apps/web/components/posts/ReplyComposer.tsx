        ...
        <div className="flex items-end gap-1 px-2 py-2">
          <label className="flex min-w-0 flex-1 items-center">
            ...
            <textarea
              ...
              enterKeyHint="send"
              className="max-h-[136px] min-h-touch-target w-full resize-none rounded-medium bg-subtle-fill px-4 py-2 text-body text-text-primary placeholder:text-text-tertiary"
            />
          </label>
          <button
            type="button"
